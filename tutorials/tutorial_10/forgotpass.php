...
if ($_POST['submit'] == 'Send') {
    ...
    $con = mysqli_connect("Localhost", "root", "1234", "register_db");
    // Check connection
    ...
    $mail->Body = $message = "You activation link is:http://localhost/php_training/tutorials/tutorial_10/resetpassword.php?email=$email&code=$code";
