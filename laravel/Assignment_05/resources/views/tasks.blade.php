    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <!-- <form action="{{  url('/search')  }}" class="form-inline" method="get">
          <label name="start-lb">Start Date : </label>
          <input class="form-control" type="date" name="start" />&nbsp;
          <label name="end-lb">End Date : </label>
          <input class="form-control" type="date" name="end" /><br><br>

          <label name="name-lb">Task Name : </label>
