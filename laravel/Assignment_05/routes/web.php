...
Route::get('/api-update/{id}', function () {
  return view('api.edit');
});


Route::get('/testmail', [TaskController::class, 'testMail']);

Route::get('/task/added/mail', [TaskController::class, 'TaskAddedMail']);
Route::get('/task/complete/mail', [ReportController::class, 'DoneReportMail']);
Route::get('/weekly/reminder/mail', [TaskController::class, 'WeeklyReminderMail']);
